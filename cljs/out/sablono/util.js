...
var x__25764__auto__ = (((x == null))?null:x);
var m__25765__auto__ = (sablono.util.to_str[goog.typeOf(x__25764__auto__)]);
if(!((m__25765__auto__ == null))){
return m__25765__auto__.call(null,x);
} else {
var m__25765__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25765__auto____$1 == null))){
return m__25765__auto____$1.call(null,x);
} else {
...
var x__25764__auto__ = (((x == null))?null:x);
var m__25765__auto__ = (sablono.util.to_uri[goog.typeOf(x__25764__auto__)]);
if(!((m__25765__auto__ == null))){
return m__25765__auto__.call(null,x);
} else {
var m__25765__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25765__auto____$1 == null))){
return m__25765__auto____$1.call(null,x);
} else {
...
var len__26176__auto___31065 = arguments.length;
var i__26177__auto___31066 = (0);
while(true){
if((i__26177__auto___31066 < len__26176__auto___31065)){
args__26183__auto__.push((arguments[i__26177__auto___31066]));

var G__31067 = (i__26177__auto___31066 + (1));
i__26177__auto___31066 = G__31067;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__26184__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq31064){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31064));
});
...
var vec__31071 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__31073;
var words = seq__31072__$1;
...
var G__31075 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__31075,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__31075;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__31076_SHARP_){
if(typeof p1__31076_SHARP_ === 'string'){
return p1__31076_SHARP_;
} else {
return cljs.core.seq.call(null,p1__31076_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__25101__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1487859337287